...
<body>
    ...
    <div class="container1">
        <form method="post">
            ...
            <div class="input">
                <label for="voltage">Voltage (Volt)</label>
            ...
            <div class="input">
                <label for="current_rate">Current Rate ($sen)</label>
    ...
    <table border="1" class="table_container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            for ($hour = 1; $hour <= 24; $hour++) {
                ...
                <div class="container2">
                    <p id="totalelectricity"><?php echo "Electricity usage per day(kWh):"."<br>" . round($energyperday,2); ?></p>
                </div>
            <?php
                }
            ?>
